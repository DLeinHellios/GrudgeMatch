...
class PlayerIcons:
    def __init__(self, master, data):
        ...
        self.generate(data)
        self.position(self.master, data.config.all['hide_sidebar'])
    ...
    def position(self, master, hideSidebar):
...
class TopMenu:
    def __init__(self, master, data, menus, icons, frames):
...
class Frames:
    ...
    def __init__(self, master, data):
        ...
        self.sideFrame = tk.Frame(master, width=110)
